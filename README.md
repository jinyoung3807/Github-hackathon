...
💬 If you want to see my github, [Click](https://github.com/jinyoung3807) <br>
```
...
## 🏆취득 자격증
- **IP 정보 검색사** <br>
  <img width="200" height = "270" alt="IP정보검색사 자격증" src="https://user-images.githubusercontent.com/80821610/198845108-a708851e-6b32-4b91-8db2-dfe1aa214278.png"> <img width="230" height = "270" alt="IP 공부과정" src="https://user-images.githubusercontent.com/80821610/198845449-a6a34bbe-f1eb-49e6-baa2-2e3f828cbfb7.png">


- **Adobe Premiere Pro** <br>
  <img  width="300" alt="premiere pro" src="https://user-images.githubusercontent.com/80821610/165899223-00e631dd-fc7f-47ca-b4a6-d3daad91330a.png">
...
- 2022.11.26 ~ 2022.11.27 봉사동아리 연수(예정)
   ``` 
   각급 기관에서 사용하고 있는 [핑퐁로봇 심화과정/ AI항공촬영]과 같은 신산업분야에 선도적인 교육의 필요성 및 교육현장의 요청에 부응하기 위해 계획된 봉사동아리 교육 연수 일정입니다.
   ``` 
---
...
- **2022**
  ...
  - 가상현실과 증강현실 그리고 메타버스
  - 인공지능_인공지능 딥러닝 개론
  - 게임개발자에게 요구되는 역량이란?(예정)
  - 뉴노멀 시대, 인스타그램의 부상과 트렌드(예정)
  - AI엔진 개발 특강(예정)
---
...
- **2021 Hallym SW Week**
  - 기초대회[파이썬 퀴즈 온 더 한림]
  - 2021 SW Coding Festival

- **2022 Hallym SW Week** 
  - 1학기 Github 이력서 해커톤 
  - 2022 SW Coding Festival(예정)
  - 완내스 파이썬 / R(예정)
  - SW 미래기술 아이디어 경진대회(예정)
  - 2학기 Github 이력서 콘테스트 해커톤
---

## 🤔앞으로의 활동 계획
- **참여하고 싶은 SW 프로그램(교내)**
  - YORK UNIVERSITY 하계 연수 프로그램
  - 캡스톤 프로젝트 참여
- **참여하고 싶은 SW 프로그램(교외)**
...
## 🤔SW학습을 통해 이루고 싶은 점
여전히 SW에 대한 지식의 부족함과 어려움을 느끼고 있고, 진로에 대한 많은 고민들 또한 가지고 있지만, 꾸준히 공부해 나아가며 차근 차근 SW능력을 길러나아갈 예정입니다. 지금까지 해왔던 것처럼 다양한 기회들의 특강, 교육봉사, 강의 등을 통해 SW 전반의 폭넓은 이해를 하고 싶고, 다양한 분야에서 나의 관심 분야를 찾아나아가며 한 분야의 전문가가 되는 것을 목표로 잡고 있습니다. 
